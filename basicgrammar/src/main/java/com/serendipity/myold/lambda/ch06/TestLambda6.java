...
public class TestLambda6 {
    List<Employee> employees = Arrays.asList(new Employee("张三", 18, 9999.99), new Employee("李四", 39, 5555.55),
            new Employee("王五", 50, 666.99), new Employee("赵六", 16, 6666.66), new Employee("田七", 8, 8888.88),
            new Employee("田七", 8, 8888.88), new Employee("田七", 8, 8888.88));
