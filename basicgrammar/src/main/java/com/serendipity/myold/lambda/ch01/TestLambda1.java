...
public class TestLambda1 {
    ...
    List<Employee> employees = Arrays.asList(new Employee("张三", 10, 10.00), new Employee("李四", 20, 20.00),
            new Employee("王五", 30, 30.00), new Employee("赵六", 40, 40.00), new Employee("田七", 50, 50.00));
