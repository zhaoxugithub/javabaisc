...
public class TestLambda02 {
    ...
    final List<Person> people = Arrays.asList(new Person("p1", "p1 message", 10), new Person("p1", "p2 message2222",
            20), new Person("p2", "p2 message", 30), new Person("p3", "p3 message", 40), new Person("p4", "p4 message"
            , 50));
