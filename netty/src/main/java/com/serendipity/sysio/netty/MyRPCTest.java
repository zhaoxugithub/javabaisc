package com.serendipity.sysio.netty;
...
public class MyRPCTest {
    ...
    public void startServer() {
        ...
        ChannelFuture bind = sbs.group(boss, worker)
                                ...
                                .childHandler(new ChannelInitializer<NioSocketChannel>() {
                                    ...
                                    protected void initChannel(NioSocketChannel ch) {
                                        log.info("server accept client port:{}" + ch.remoteAddress()
                                                                                    .getPort());
        ...
        try {
            ...
            log.error("startServer:{}", e.getMessage());
        }
    }
...
class ServerRequestHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (buf.readableBytes() >= 110) {
            ...
            log.info("server response id: {} ", header.getRequestID());
...
class ClientFactory {
    ...
    private NioSocketChannel create(InetSocketAddress address) {
        ...
        ChannelFuture connect = bs.group(clientWorker)
                                  ...
                                  .connect(address);
        try {
            return (NioSocketChannel) connect.sync()
                                             .channel();
        } catch (InterruptedException e) {
