...
public class HttpServerV1 {
    ...
    public void analysisHttpHeader(Socket client) throws IOException {
        ...
        BufferedWriter bufferedWriter = getBufferedWriter(client, url, version);
        bufferedWriter.flush();
    }

    private static BufferedWriter getBufferedWriter(Socket client, String url, String version) throws IOException {
